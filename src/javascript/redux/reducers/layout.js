...
const list = [
    {id: '1000000', name: '윙크소개',  level: 0, defaultLink: '/wink/lookview', hasChild : true},
    ...
    {id: '2000000', name: '우리아이 현황',  level: 0, defaultLink: '/mykids/total', hasChild : true},
