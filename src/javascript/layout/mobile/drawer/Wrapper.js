...
const icons = {
    ...
    '10000' : (<CustomIcon type="MdChildCare" />),
    '20000' : (<CustomIcon type="MdAddCircle" />),
    '30000' : (<CustomIcon type="MdFilterVintage" />),
    '40000' : (<CustomIcon type="MdSchool" />),
    '50000' : (<CustomIcon type="MdBuild" />),
    '60000' : (<CustomIcon type="MdNaturePeople" />),
    '70000' : (<CustomIcon type="FaTrophy" roots="FontAwesome"/>),

    '4070000' : (<CustomIcon type="FaBullhorn" roots="FontAwesome"/>),
    '4070100' : (<CustomIcon type="MdCake" />),
    '4070200' : (<CustomIcon type="FaMicrophone" roots="FontAwesome"/>),
